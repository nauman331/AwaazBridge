...
const Profile: React.FC = () => {
    ...
    const [profileData, setProfileData] = useState({
        name: userdata?.name || 'Michael Chen',
        email: userdata?.email || 'michael.chen@financefire.com',
        phone: userdata?.phone || '+1 234 567 8902',
        adminId: userdata?.googleId || 'ADM2019001',
        ...
        <div className="min-h-screen bg-[#FFF7F0] dark:bg-[#002B5B] p-4 sm:p-6">
            <div className="max-w-7xl mx-auto">
                <div className="bg-white dark:bg-[#0a1a33] rounded-xl shadow-lg overflow-hidden">
                    {/* Header */}
                    <div className="bg-gradient-to-r from-red-600 to-red-500 px-4 sm:px-8 py-6">
                        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                            <div className="flex flex-col sm:flex-row items-start sm:items-center space-y-4 sm:space-y-0 sm:space-x-4">
                                ...
                                <div className="text-white">
                                    ...
                                    <p className="text-red-100 text-lg">{profileData.role}</p>
                                    <p className="text-sm text-red-200">ID: {profileData.adminId}</p>
                                </div>
                            </div>
                            <button
                                onClick={() => setIsEditing(!isEditing)}
                                className="bg-white text-red-600 px-4 py-2 rounded-lg hover:bg-red-50 transition-all duration-200 flex items-center space-x-2 shadow-md hover:shadow-lg font-medium"
                            >
                                <Edit size={16} />
                        ...
                        <div className="xl:col-span-2 space-y-6">
                            <div className="bg-[#FFF7F0] dark:bg-[#112244] rounded-xl p-4 sm:p-6 shadow-sm">
                                <h2 className="text-xl font-semibold mb-6 flex items-center text-[#002B5B] dark:text-white">
                                    <User className="mr-3 text-red-600" size={20} />
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 lg:gap-6">
                                    <div>
                                        ...
                                        {isEditing ? (
                                            <input
                                                ...
                                                className="w-full px-4 py-3 border border-red-300 rounded-lg focus:ring-2 focus:ring-red-600 focus:border-transparent bg-white dark:bg-[#223355] text-[#002B5B] dark:text-white transition-all"
                                            />
                                        ) : (
                                    ...
                                    <div>
                                        ...
                                        <p className="text-red-600 py-3 font-semibold">{profileData.clearanceLevel}</p>
                                    </div>
                                    <div>
                                ...
                                {isEditing && (
                                    <div className="mt-6 pt-4 border-t border-red-200">
                                        <button
                                            onClick={handleSave}
                                            className="bg-gradient-to-r from-red-600 to-red-500 text-white px-6 py-3 rounded-lg hover:brightness-110 transition-all duration-200 font-medium shadow-lg"
                                        >
                                            Save Changes
                                        </button>
                                    </div>
                        ...
                        <div className="space-y-6">
                                ...
                                <div className="space-y-4">
                                    <div className="flex items-center justify-between p-3 bg-white dark:bg-[#223355] rounded-lg">
                                        <span className="flex items-center text-[#444] dark:text-[#cfd8e3]">
                                            <Server className="mr-2 text-red-600" size={16} />
                                            Server Status
                                        </span>
                                        <span className="px-2 py-1 bg-red-100 text-red-600 rounded-full text-xs font-semibold">Online</span>
                                    </div>
                                    <div className="flex items-center justify-between p-3 bg-white dark:bg-[#223355] rounded-lg">
                                        <span className="flex items-center text-[#444] dark:text-[#cfd8e3]">
                                            <Users className="mr-2 text-red-500" size={16} />
                                            Active Users
                                        </span>
                                    ...
                                    <div className="flex items-center justify-between p-3 bg-white dark:bg-[#223355] rounded-lg">
                                        ...
                                        <span className="px-2 py-1 bg-red-100 text-red-600 rounded-full text-xs font-semibold">3</span>
                                    </div>
                                    <div className="flex items-center justify-between p-3 bg-white dark:bg-[#223355] rounded-lg">
                                        <span className="flex items-center text-[#444] dark:text-[#cfd8e3]">
                            ...
                            <div className="bg-[#FFF7F0] dark:bg-[#112244] rounded-xl p-4 sm:p-6 shadow-sm">
                                ...
                                <div className="space-y-2">
                                    <button className="w-full text-left px-4 py-3 text-red-600 hover:bg-white dark:hover:bg-[#223355] rounded-lg transition-all duration-200 font-medium">
                                        User Management
                                    </button>
                                    <button className="w-full text-left px-4 py-3 text-red-500 hover:bg-white dark:hover:bg-[#223355] rounded-lg transition-all duration-200 font-medium">
                                        Course Management
                                    </button>
                                    <button className="w-full text-left px-4 py-3 text-red-600 hover:bg-white dark:hover:bg-[#223355] rounded-lg transition-all duration-200 font-medium">
                                        System Reports
